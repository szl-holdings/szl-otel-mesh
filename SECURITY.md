...
We take security seriously. If you discover a vulnerability in uds-mesh, please report it privately so we can investigate and remediate before public disclosure.

**Preferred channel:** [security@szlholdings.com](mailto:security@szlholdings.com)

**Alternate channel:** [Open a private security advisory](https://github.com/szl-holdings/uds-mesh/security/advisories/new) on GitHub.
...
- UDS span schemas and bundle definitions in this repository.
- Governance receipt formats, attestation structures, and schema validation logic.
